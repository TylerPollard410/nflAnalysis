...
##
golem::fill_desc(
  pkg_name = "nflAnalysis", # The name of the golem package containing the app (typically lowercase, no underscore or periods)
  pkg_title = "NFL Analysis", # What the Package Does (One Line, Title Case, No Period)
  pkg_description = "Analyze and Visualize NFL Data.", # What the package does (one paragraph).
  authors = person(
